    ...
    <>
      <div className="relative w-full h-[410px] bg-black m-auto">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center space-y-4 px-4 sm:px-6 md:px-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white text-center">Shopping Cart</h1>
      ...
      <div className="w-full max-w-7xl mx-auto p-4">
        <div className="space-y-4">
          ...
          <div className="flex space-x-2">
            ...
            />
            <button onClick={handleApplyCoupon} className="bg-[#FF9F0D] text-white p-3 rounded-md">
              Apply
            </button>
          </div>
          {discount > 0 && <div className="text-green-500">Coupon Applied! You get {discount}% off.</div>}
        </div>
          ...
          <div className="p-6 space-y-4 border rounded-md bg-white">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-bold text-gray-800">
                ...
                {(
                  products.reduce((sum, product) => sum + product.price * product.quantity, 0) -
                  (discount / 100) * products.reduce((sum, product) => sum + product.price * product.quantity, 0)
                ).toFixed(2)}
              </span>
            </div>
          </div>
